...
class PhishingResultCard extends StatelessWidget {
  ...
  String get _meaningText {
    switch (result.riskLevel) {
      case RiskLevel.safe:
        return 'Sentri did not identify strong phishing indicators in this link.';

      case RiskLevel.suspicious:
        return 'Some characteristics of this link deserve extra caution before you open it.';

      case RiskLevel.highRisk:
        return 'This link contains several characteristics associated with high-risk phishing attempts.';
    }
  }
