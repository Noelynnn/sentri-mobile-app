...
class SecurityLessons {
  ...
  static const List<SecurityLesson> all = [
    ...
    SecurityLesson(
      ...
      description:
          'Learn how common mobile-money scams work and how to protect your money and account.',
    ...
    SecurityLesson(
      ...
      description:
          'Recognize common WhatsApp scams, impersonation attempts, and suspicious requests.',
    ...
    SecurityLesson(
      ...
      description:
          'Learn how scammers use fake jobs, interviews, and recruitment messages to steal money or information.',
    ...
    SecurityLesson(
      title: 'Romance Scams',
      description:
          'Learn how online relationships can be manipulated to build trust and request money.',
    ...
    SecurityLesson(
      ...
      description:
          'Understand how criminals can take control of a mobile number and why account security matters.',
    ...
    SecurityLesson(
      ...
      description:
          'Spot fake stores, unrealistic deals, and payment traps when shopping online.',
    ...
    SecurityLesson(
      ...
      description:
          'Learn how criminals pretend to be trusted people, companies, or authorities.',
    ...
    SecurityLesson(
      ...
      description:
          'Learn what to do if you have already shared information, sent money, or interacted with a suspicious person.',
    ...
    SecurityLesson(
      ...
      description:
          'Learn how an extra verification step can help protect your accounts.',
    ...
    SecurityLesson(
      ...
      description:
          'Build safer habits for protecting your phone, computer, and personal data.',
    ...
    SecurityLesson(
      ...
      description:
          'Learn how to reduce the amount of personal information you expose online.',
    ...
    SecurityLesson(
      ...
      description:
          'Learn to recognize suspicious messages, websites, and links.',
    ...
    SecurityLesson(
      ...
      description:
          'Learn how to protect your privacy and avoid common social-media scams.',
